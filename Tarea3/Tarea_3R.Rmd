...
Presentamos una tabla de calidad de frecuencia relativa de las personas ocupadas y no ocupadas de la muestra.

Para ello, debemos considerar quiénes están ocupados y quiénes no. Personas ocupadas las definiremos como (condicional `OR`):
...
|--------------------------|-----------------------------------|
| `o1=1` o `o2=1` o `o3=1` | `o1=2` y `o2=2` y `o3=2` y `o6=1` |
